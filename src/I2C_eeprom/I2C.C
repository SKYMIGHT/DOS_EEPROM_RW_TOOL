...
void main(int argc, char *argv[])
{
  ...
  if (argc == 4)
  {
        ...
        if(argc != 4)
        { 
        printf("command: i2ctool slaveaddr [arguments] [filename]\n");
        return;
        } 
        ...
        fclose(file);
        printf("Load binary %s file  success!!!\n",argv[3]);  
			  }
  ...
  {
    printf("I2C ver 1.2\n");
    printf("This program writes binary file from I2C independently of BIOS\n\n");
    printf("command: i2ctool slaveaddr [arguments] [filename]\n");
    printf("         slaveaddr = slaveaddr \n");
    printf("         Argument:        \n");
    printf("         -w        write binray.bin to eeprom\n");
    printf("         -c        compare binray.bin with eeprom\n");
     printf("examples:\n");
    printf(" i2ctool 0xa8 -w file.bin -- Write file.bin to eeporm\n");
    return;
  }
